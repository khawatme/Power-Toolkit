# Power-Toolkit Development Guide

The complete guide for building, extending, and testing Power-Toolkit. For installation see the [README](../README.md); for what each tab does, see the [User Guide](USER-GUIDE.md).

## Table of Contents

- [Getting Started](#getting-started)
- [Project Structure](#project-structure)
- [How to Implement a New Tab](#how-to-implement-a-new-tab)
- [Best Practices](#best-practices-for-tab-development)
- [Memory Leak Prevention Patterns](#memory-leak-prevention-patterns)
- [Testing](#testing)
...
5. **Commit with Clear Messages:**
   ```bash
   git commit -m "feat(mytab): add my new feature"
   ```
6. **Push to Your Fork:**
   ```bash
...
Power-Toolkit uses [Conventional Commits](https://www.conventionalcommits.org/):
...
**Subject rules:** imperative mood ("add", not "added"), lowercase, no trailing period, under 50 characters.
