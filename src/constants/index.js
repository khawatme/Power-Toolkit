...
export const Config = {
    ...
    DEFAULT_TAB_COLOR: App.DEFAULT_TAB_COLOR,
    DEVELOPER_NAME: App.DEVELOPER_NAME,
    LICENSE_TEXT: App.LICENSE_TEXT,
    MAIN: App.MAIN,
    AGENT_PUBLISH: App.AGENT_PUBLISH,
    ...
    DATAVERSE_PAGINATION: Dataverse.DATAVERSE_PAGINATION,
    DATAVERSE_BATCH: Dataverse.DATAVERSE_BATCH,
    SYSTEM_FIELDS: Dataverse.SYSTEM_FIELDS,
    FIELD_TYPES: Dataverse.FIELD_TYPES,
    AGGREGATE_TYPE_COMPAT: Dataverse.AGGREGATE_TYPE_COMPAT,
    ATTRIBUTE_TYPE_TO_AGGREGATE_CATEGORY: Dataverse.ATTRIBUTE_TYPE_TO_AGGREGATE_CATEGORY,
    FORM_TYPES: Dataverse.FORM_TYPES,
    SYSTEM_FORM_TYPES: Dataverse.SYSTEM_FORM_TYPES,
    SYSTEM_FORM_TYPE_LABELS: Dataverse.SYSTEM_FORM_TYPE_LABELS,
    WELL_KNOWN_SOLUTIONS: Dataverse.WELL_KNOWN_SOLUTIONS,
    ...
    CUSTOM_API_FIELD_TYPES: Dataverse.CUSTOM_API_FIELD_TYPES,
    CUSTOM_API_BINDING_TYPES: Dataverse.CUSTOM_API_BINDING_TYPES,
    CUSTOM_API_PROCESSING_TYPES: Dataverse.CUSTOM_API_PROCESSING_TYPES,
    CUSTOM_API_TYPE_DEFAULTS: Dataverse.CUSTOM_API_TYPE_DEFAULTS,

    // Plugin constants
    PLUGIN_MESSAGES: Plugin.PLUGIN_MESSAGES,
    PLUGIN_STAGES: Plugin.PLUGIN_STAGES,
    PLUGIN_IMAGE_NAMES: Plugin.PLUGIN_IMAGE_NAMES,
    PLUGIN_CONTEXT_BUTTONS: Plugin.PLUGIN_CONTEXT_BUTTONS,
    ...
    CSV_DELIMITER: UI.CSV_DELIMITER,
    ...
    MAX_NOTIFICATIONS: UI.MAX_NOTIFICATIONS,
    ...
    MESSAGES: {
        ...
        QUICK_CHECK: Messages.QUICK_CHECK,
        EVENT_MONITOR: Messages.EVENT_MONITOR,
        SOLUTION_LAYERS: Messages.SOLUTION_LAYERS,
        POWER_AUTOMATE_FLOWS: Messages.POWER_AUTOMATE_FLOWS,
        CUSTOM_API: Messages.CUSTOM_API,
